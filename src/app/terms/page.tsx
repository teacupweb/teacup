          ...
          <div className='max-w-4xl mx-auto space-y-10'>
            ...
            <section className='space-y-3'>
              ...
              <ul className='list-disc pl-6 space-y-2 text-muted-foreground'>
                ...
                <li>Attempt to access accounts or systems without permission.</li>
                <li>Upload malware or disrupt the Service.</li>
                <li>Reverse engineer or abuse the Service beyond permitted use.</li>
              </ul>
            </section>
            ...
            <section className='space-y-3'>
              ...
              <p className='text-muted-foreground'>
                ...
                <a className='text-rose-600 hover:underline' href='mailto:support@teacup.com'>
                  support@teacup.com
                </a>{' '}
                or via the{' '}
                <Link className='text-rose-600 hover:underline' href='/contact'>
                  Contact page
                </Link>
                .
              </p>
