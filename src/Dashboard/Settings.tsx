      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
        ...
        <div className='lg:col-span-2 space-y-6'>
          <div className='bg-white p-6 rounded-2xl border border-slate-100 shadow-sm'>
            <h3 className='font-bold text-xl text-slate-800 mb-4 pb-2 border-b border-slate-50'>Account Settings</h3>
          ...
          <div className='bg-white p-6 rounded-2xl border border-slate-100 shadow-sm'>
             <h3 className='font-bold text-xl text-slate-800 mb-4 pb-2 border-b border-slate-50'>Team Management</h3>
             <div className='space-y-4'>
                <div>
                  <label className='block text-sm font-medium text-slate-700 mb-1'>Invite Team Member</label>
                ...
                <div className='pt-2'>
                  <h4 className='text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3'>Pending Invites</h4>
                  <div className='space-y-3'>
                    <div className='flex items-center justify-between bg-slate-50 p-3 rounded-lg'>
                      <div className='flex items-center gap-3'>
                        ...
                        <span className='text-sm text-slate-600'>jane.doe@example.com</span>
                      </div>
                      <span className='text-xs text-orange-500 font-medium bg-orange-50 px-2 py-1 rounded-full'>Pending</span>
                    </div>
                  </div>
                </div>
             </div>
          ...
          <div className='bg-white p-6 rounded-2xl border border-slate-100 shadow-sm'>
             <h3 className='font-bold text-xl text-slate-800 mb-4 pb-2 border-b border-slate-50'>Appearance</h3>
             <div className='space-y-4'>
                <div className='flex items-center justify-between p-3 hover:bg-slate-50 rounded-lg transition-colors'>
                <div>
        ...
        <div className='space-y-6'>
          ...
          <div className='bg-red-50 p-6 rounded-2xl border border-red-100'>
            ...
            <p className='text-red-600/80 text-sm mb-4'>Once you logout, you will need to enter your credentials to access the dashboard again.</p>
            <button
